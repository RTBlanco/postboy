...
class Notification:
    def __init__(self, UUID, jsessionid):
        self.UUID = UUID
    ...
    def send_daily(self,device_type, k_lang, l_lang):
        """ Posts the requests for daily refreshser """

        sticke_test_url = f'https://192.168.254.54:7070/rest/external/{self.UUID}/REFRESHER/{device_type}/{k_lang}/{l_lang}'
